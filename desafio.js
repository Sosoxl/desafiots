...
let data = document;
//cadastrar
let data_ = document.querySelector(".inputdata");
let pacote_ = document.querySelector(".NomePacote");
...
const Cadastrar = () => {
    ...
    let descricao = descricao_.value;
...
const lista = () => {
   ...
   class="editar">editar</button> <br> <br> <button onclick ="excluir(${index})"class="limpar">excluir</button> </div> </div>`;
    }
};
...
let pacote = document.querySelector(".inputnome");
let data_da_viagem = document.querySelector(".inputdata");
let descricao = document.querySelector(".descricao_do_pacote");
let guardar_id;
let guardar_status;
...
const editar = (_nome, _data, _descricao, _status, _id) => {
    ...
    button.innerHTML = "<button onclick ='parte_dois()' class='editar'>editar</button>";
};
const parte_dois = () => {
    ...
    lista();
    button.innerHTML = "<button onclick ='Cadastrar()'class='Cadastrar'>Cadastrar</button>";
};
